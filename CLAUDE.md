...
- **Entitlements File**: `Config/MineOpsCompanion.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/MineOpsCompanion.entitlements`:
